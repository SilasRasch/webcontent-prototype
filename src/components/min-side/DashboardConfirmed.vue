...
<template>
    <div class="grid grid-cols-2 md:grid-cols-4 gap-2 p-2 rounded-xl mt-0 w-[90vw]">
        ...
        <div class="flex flex-col gap-2">
            ...
            <OrderCardMini v-for="index in planned" :key="index" :order-id="index.orderId" brand="Brand" color-class="bg-yellow-500" :admin="props.admin">Projektnavn</OrderCardMini>
        </div>
        ...
        <div class="flex flex-col gap-2">
            ...
            <OrderCardMini v-for="index in production" :key="index" :order-id="index.orderId" brand="Brand" color-class="bg-blue-500" :admin="props.admin">Projektnavn</OrderCardMini>
        </div>
        ...
        <div class="flex flex-col gap-2">
            ...
            <OrderCardMini v-for="index in feedback" :key="index" :order-id="index.orderId" brand="Brand" color-class="bg-green-500" :admin="props.admin">Projektnavn</OrderCardMini>
        </div>
    </div>
</template>